...
| 完成口径 | 以第 9 章命令、测试输出和提交记录判定；教材中的示范输出不代表学习者已经复现 |
| 学习顺序 | 第 0-7 章按序建立工具链，第 8 章组装项目，第 9 章验收；第 10-11 章按需查阅 |
...
| 范围 | 类型 | 阅读承诺 |
|---|---|---|
| 第 0-9 章 | `instructional` | 建立环境、路径、版本控制、调试、测试、HTTP 和贯通项目能力 |
...
对应结构。`MockTransport` 让你先把这些可控部分练成确定性技能；它不会模拟真实网络。下一步
